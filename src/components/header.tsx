                ...
                <div className="ml-auto mt-1">
                    <div className="mt-1 text-center">
                        <Link href="/api/auth/steam"
                              className="items-center bg-gray-80 font-bold text-white px-4 py-1 rounded-lg bg-gray-800 hover:bg-gray-900 transition inline-flex">
                            <button className="justify-center">S&#39;identifier avec</button>
